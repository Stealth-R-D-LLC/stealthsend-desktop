...
const SettingsAppNotifications = () =>
  import('@/views/settings/app-notifications.vue');
...
const SettingsDesktopNotifications = () =>
  import('@/views/settings/desktop-notifications.vue');
const SettingsEmailNotifications = () =>
  import('@/views/settings/email-notifications.vue');
