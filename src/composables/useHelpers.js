...
export default function useHelpers() {
  ...
  function formatAmount(amount, roundDecimals = false, decimals = 2, minimumFractionDigits = 2) {
    if (roundDecimals) {
      return new Intl.NumberFormat('en-IN', {minimumFractionDigits: minimumFractionDigits}).format(amount);
    }
    return new Intl.NumberFormat('en-IN', {minimumFractionDigits: minimumFractionDigits}).format(round(amount, decimals));
  }
