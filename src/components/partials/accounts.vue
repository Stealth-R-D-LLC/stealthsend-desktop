      ...
      >
        <div class="card__inner">
          ...
          <div class="amount-container">
            <p class="currency">
              {{ isHiddenAmounts ? '•••' : formatAmount(Math.abs(account.utxo, true, 8)) }} XST
            </p>
            <p class="grey">
              ~
              <template v-if="Number(account.utxo) * XST_USD_RATE < 1">
                {{ isHiddenAmounts ? '•••' : formatAmount(Math.abs(account.utxo * XST_USD_RATE), true) }}
              </template>
              <template v-else>
                {{ isHiddenAmounts ? '•••' : formatAmount(Math.abs(account.utxo * XST_USD_RATE), false) }}
              </template>
              USD
            </p>
          </div>
        ...
        >
          <div class="card__inner">
            ...
            <div class="amount-container">
              ...
              <p class="grey">
                ~ ${{
                  isHiddenAmounts ? '•••' : formatAmount(Math.abs(account.utxo * XST_USD_RATE, false, 8))
                }}
                USD
              </p>
            </div>
