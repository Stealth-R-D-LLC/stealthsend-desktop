...
// about coin_type' https://github.com/satoshilabs/slips/blob/master/slip-0044.md (0' - hardened derivation used for BTC mainnet, 1' hardened derivation used for tesnet [all coins])
...
console.log('\n');
let child01 = root.derivePath("m/44'/1'/0'/0/1"); // m - master node, 44' - purpose, 1' - coin_type (0' mainnet, 1' testnet), 0 - change, 1 - address_index
